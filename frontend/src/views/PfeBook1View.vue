...
<div 
 ...
 <h1  class="description-titre">{{book.titre}}</h1>
<p class="description-paragraph">{{book.text}}</p>
</div>
  </section>
...
<button class="shadow-button" style="border:none;" @click="openOffre(offer.id_offre)">Voir Offre</button>
<pre>{{offer.offer_id}}</pre>
</div>
<div class="container-right">
<div class="card">
  <div class="column">
