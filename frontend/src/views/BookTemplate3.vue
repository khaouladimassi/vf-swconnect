...
<header>
    ...
    <h1 style="color:#000000"> {{this.entreprise.nom}}</h1>
</header>
<div class="container-containers" style= " background-color:#fff;">
  <div class="container-left">
  <h1 style="color:#000000; font-size:25px; position:relative;left:-150px;top:-50px;" >Bienvenue chez       <span  style="color:#000000; font-weight:bold; font-size:40px; ">{{this.entreprise.nom}}</span></h1>
...
<div class="container-right" style="background-color:#000000">
  ...
  <h1>Entreprise  est une entreprise qui cherche à changer la façon dont les gens se connectent.</h1>
  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
  </div>
    </section>
    <section v-for="offer  in offerDetails" :key="offer.id" >
<div class="container-containers">
  ...
  <button class="shadow-button2" style="border:none;">Voir Offre</button>
</div>
...
<div class="container-right-switch">
  ...
  <ul>
    <li style="color:#000000;">{{entreprise.telephone}}</li>
    <li style="color:#000000;">{{entreprise.location}}</li>
    <li style="color:#000000;">{{entreprise.email}}</li>
  </ul>
  </div>
</div>
</div>
