      ...
      <div class="nav-2" style="border-right: 1px solid #dee2e6">
        <nav class="nav-main-menu-2">
          <ul class="main-menu-2">
            ...
            <li>
              <router-link to="/Demandes" class="active dashboard2"
                ><img
                  src="template/assetss/imgs/template/icons/briefcase2.svg"
                  alt="jobBox"
                /><span class="name">Mes Demandes</span></router-link
              >
            </li>
            <li>
              <router-link :to="'/EtudDrive/' + etudiant.id">
                <img
                  src="template/assetss/imgs/template/icons/folder.svg"
                  alt="jobBox"
                          ...
                          <table class="table">
                            ...
                            <tbody>
                              <tr v-for="demande in demandes" :key="demande.id">
                                <th scope="row" class="cus-td">
                                  <div class="image-box">
                                    <img
                                      :src="demande.profile_logo"
                                      alt="jobBox"
                                      style="width: 30px"
                                    />
                                  </div>
                                ...
                                <td class="cus-td">
                                  <a :href="'/OffreDetails/' + demande.offer">{{
                                    demande.offer_title
                                  }}</a>
                                </td>
                                <td class="cus-td">
                                  <a
                                    :href="
                                      '/OffreDetails/' + demande.entreprise_id
                                    "
                                    >{{ demande.entreprise_nom }}</a
                                  >
                                </td>
                                <td class="cus-td">
                                  <span class="card-time">{{
                                    demande.created_at.slice(0, 10)
                                  }}</span>
                                </td>
                                <td class="cus-td">
                                  <template
                                  ...
                                  >
                                    <img
                                      src="template/assets/imgs/page/candidates/pended.png"
                                      alt="verified"
                                      style="height: 20px; margin-top: 3px"
                                    />
                                  </template>
                                  <template
                                    v-if="demande.status === 'accepted'"
                                  >
                                    <img
                                      src="template/assets/imgs/page/candidates/accepted.png"
                                      alt="verified"
                                      style="height: 20px; margin-top: 3px"
                                    />
                                  </template>
                                  <template v-if="demande.status === 'refused'">
                                    <img
                                      src="template/assets/imgs/page/candidates/refused.png"
                                      alt="verified"
                                      style="height: 20px; margin-top: 3px"
                                    />
                                  </template>
...
export default {
  ...
  methods: {
    ...
    fetchDemandes() {
      const userId = localStorage.getItem("user_id");
      axios
        .get(`http://127.0.0.1:8000/api/demande/etudiant/${userId}/`)
        .then((response) => {
