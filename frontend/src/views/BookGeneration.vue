<template>
      ...
      <div class="nav-2" style="border-right: 1px solid #dee2e6">
        <nav class="nav-main-menu-2">
          <ul class="main-menu-2">
            ...
            <li>
              <router-link to="/BookGeneration" class="dashboard2 active" 
                ><img
        ...
        <div class="tab-content" >
          <div class="box-heading-2 " >
            <div class="box-title-2" style="width:100%; display:flex;">
              <h3 class="mb-35">Générer Pfe Book</h3>
              ...
              <div class="section-box-2">
                <div class="container-22">
                  ...
                  <div v-for="offer in offers" :key="offer.id"  class="col-xl-12 col-12">
                    ...
                    <div class="card-grid-2 hover-up" :class="{'selected-offer': isSelected(offer.id)}"  @click="toggleSelection(offer.id)"><span class="flash"></span>
                      <div class="row">
  ...
  export default {
    ...
    computed: {
    ...mapGetters(['getSelectedOffers']),
    isSelected() {
      return (offerId) => {
        return this.getSelectedOffers.includes(offerId);
      };
    }
  },
    created() {
  ...
  mounted() {
    ...
    methods: {
      ...
      ...mapActions(['updateSelectedOffers']),
    toggleSelection(offerId) {
      ...
      this.updateSelectedOffers(selectedOffers);
    },

    creerBook() {
      if (this.getSelectedOffers.length < 3) {
        alert('Please select at least three offers.');
      } else {
        this.$router.push({ name: 'BookGeneration2', params: { selectedOffers: this.getSelectedOffers } });
        console.log(this.getSelectedOffers);
      }
    }
