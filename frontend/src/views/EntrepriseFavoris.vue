            ...
            <div class="col-lg-1222">
              <div class="section-box-2">
                <div class="container-22">
                  ...
                  <div v-for="favorite_etudiant in favoriteEtudiants" :key="favorite_etudiant.id"  class="col-xl-12 col-12">
                    <div class="card-grid-2 hover-up"><span class="flash"></span>
                      <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12">
                          <div class="card-grid-2-image-left">
                        <div class="image-box"><img  :src="favorite_etudiant.profile_photo" alt="jobBox" style="width: 52px;;"></div>
                            <div class="right-info"><a :href="'/EtudiantDetails/' + favorite_etudiant.etudiant_id"  class="name-job">{{favorite_etudiant.prenom}} {{favorite_etudiant.nom}}</a><span class="location-small">{{favorite_etudiant.location}}</span></div>
                          </div>
                        </div>
                        <div class="col-lg-6 text-start text-md-end pr-60 col-md-6 col-sm-12">
                          <div class="pl-15 mb-15 mt-30">       <a v-for="(skill, index) in favorite_etudiant.skills" :key="index" class='btn btn-grey-small cus-mr mr-5' href='jobs-grid.html'>
                                    {{ skill }}
                                </a></div>
                        </div>
                      </div>
                      <div class="card-block-info">
                        <h4><a >{{favorite_etudiant.role}}</a></h4>
                        <div class="mt-5"><span class="card-briefcase">{{favorite_etudiant.domain}}</span><span class="card-time">{{favorite_etudiant.date_naissance}}</span></div>
                        <p class="font-sm color-text-paragraph mt-10">{{favorite_etudiant.bio}}</p>
                        <div class="card-2-bottom mt-20">
                          <div class="row">
                            <div class="col-lg-7 col-7"><span class="card-text-price">{{ favorite_etudiant.education }}</span></div>
                            <div class="col-lg-5 col-5 text-end">
                              <a class="btn btn-apply-now"  style="    margin-left: 14px;color:#447AB8" :href="'/EtudiantDetails/'+ favorite_etudiant.etudiant_id">Voir Etudiant</a>
                            </div>
                          </div>
                        </div>
                      </div>
