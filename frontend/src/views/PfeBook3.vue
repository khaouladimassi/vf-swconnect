        ...
        <div class="container-containers" style="background-color: #fff">
          <div class="container-left">
            ...
            >
              Bienvenue chez
              <span
                style="color: #000000; font-weight: bold; font-size: 40px"
                >{{ book.entreprise_nom }}</span
              >
            </h1>
        ...
        <div class="description">
          <textarea
            ...
            style="
              ...
              color:#fff;
              font-family: 'Open Sauce Sans'; font-weight:bold;font-size: 1.5rem;
              text-align:center;
            "
          >
Entreprise  est une entreprise qui cherche à changer la façon dont les gens se connectent.</textarea
          >
          <textarea
          rows="8"
            v-model="book.text"
      ...
      <section v-for="offer in book.offer_details" :key="offer.id">
        <div class="container-containers">
          <div class="container-left" style="background-color: #000000">
            ...
            <div
              style="font-weight: bold; color: #fff; margin-bottom: 20px"
              class="title"
            >
              Compétences
            </div>
            ...
            <button class="shadow-button2" @click="openOffre(offer.offer_id)">
              Voir Offre
            </button>
          </div>
        </div>
      ...
      <section>
        <div class="container-containers-2">
          ...
          <div class="container-right-switch">
            ...
            <button class="update-button" @click="updateBook(this.book.id)">
              Enregistrer
            </button>
          </div>
        </div>
    ...
    async updateBook(bookId) {
      ...
      try {
        const response = await axios.put(
          `http://127.0.0.1:8000/api/update-book/${bookId}/`,
          formData,
          {
            headers: {
...
.shadow-effect {
  ...
  height: 380px;
  border-radius: 20%;
  box-shadow: inset 0 0 50px #260e69, inset 20px 0 80px #1f41bb,
    inset -20px 0 80px #260e69, inset 20px 0 300px #1f41bb,
    inset -20px 0 300px #260e69, 0 0 50px #260e69, -10px 0 80px #1f41bb,
    10px 0 80px #1f41bb;
}
.container-right img {
  z-index: 2;
